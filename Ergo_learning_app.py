...
#MarketCap comparison of any coin 
...
print("Ergo was born on a crypto winter, will tell you this any GPU that mined $Erg!")
...
print("This bot was born to be my python exercise, now will try to finish it.")
